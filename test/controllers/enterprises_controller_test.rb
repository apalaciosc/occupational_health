...
class EnterprisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post enterprises_url, params: { enterprise: { departament: @enterprise.departament, district: @enterprise.district, economic_activity: @enterprise.economic_activity, location: @enterprise.location, name: @enterprise.name, workplace: @enterprise.workplace } }
    end
  ...
  test "should update enterprise" do
    patch enterprise_url(@enterprise), params: { enterprise: { departament: @enterprise.departament, district: @enterprise.district, economic_activity: @enterprise.economic_activity, location: @enterprise.location, name: @enterprise.name, workplace: @enterprise.workplace } }
